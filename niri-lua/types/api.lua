...
---@alias SpawnOpts { cwd: string?, env: table<string, string>?, clear_env: boolean?, stdin: string|boolean|"pipe"?, stdin_pipe: boolean?, capture_stdout: boolean?, capture_stderr: boolean?, text: boolean?, detach: boolean?, stdout: boolean|fun(stream: "stdout"|"stderr", err: string?, chunk: string?)?, stderr: boolean|fun(stream: "stdout"|"stderr", err: string?, chunk: string?)?, on_exit: fun(result: SpawnResult)? }
